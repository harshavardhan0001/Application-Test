...
class ProductControllerTest extends \Codeception\Test\Unit
{
    ...
    public function testAddProductAlreadyExists()
    {
        ...
        // Mock the request parameters
        $controller->request = ['id'=>1, 'name' => 'Product 1', 'state' => 'abcd', 'zip'=>'12345', 'amount' => 1, 'quantity' => 2, 'item' => 'a2b3'];

        // Mock the data returned by the Product model's getData() method
        $mockData = [
            ['id'=>1, 'name' => 'Product 1', 'state' => 'abcd', 'zip'=>'12456', 'amount' => 1, 'quantity' => 3, 'item' => 'a2b3']
        ];
        // Set the mock Product model in the controller
        $reflection = new ReflectionClass(\App\Controllers\ProductController::class);
        $property = $reflection->getProperty('data');
    ...
    public function testUpdateProduct()
    {
        ...
        // Mock the data returned by the Product model's getData() method
        $mockData = [
            ['id'=>1, 'name' => 'Product 1', 'state' => 'abcd', 'zip'=>'12345', 'amount' => 1, 'quantity' => 2, 'item' => 'a2b3']
        ];
        // Set the mock Product model in the controller
        $reflection = new ReflectionClass(\App\Controllers\ProductController::class);
        $property = $reflection->getProperty('data');
    ...
    public function testDeleteProduct()
    {
        ...
        // Mock the request parameters
        $controller->request = ['id'=>1, 'name' => 'Product 1', 'state' => 'aass', 'zip'=>'axxa', 'amount' => 1, 'quantity' => 2, 'item' => 'a'];

        // Mock the data returned by the Product model's getData() method
        $mockData = [
            ['id'=>1, 'name' => 'Product 1', 'state' => 'a', 'zip'=>'a', 'amount' => 1, 'quantity' => 222, 'item' => 'a']
        ];
        // Set the mock Product model in the controller
        $reflection = new ReflectionClass(\App\Controllers\ProductController::class);
        $property = $reflection->getProperty('data');
